...
\begin{tikzpicture}[node distance=1.5cm, auto,
    method/.style={rectangle, draw=blue!60, fill=blue!5, very thick, minimum width=5cm, minimum height=1cm, rounded corners},
    artifact/.style={rectangle, draw=gray!60, fill=gray!5, minimum width=4cm, minimum height=0.7cm},
    arrow/.style={->, >=stealth, thick}]

% Model-Driven path
\node[method] (yaml) {YAML Domain Model};
...
\draw[arrow, bend right=30, dashed] (feedback.east) to node[right] {errors} (filler.east);

% Pure LLM path
\node[method, right=7cm of yaml, fill=red!5, draw=red!60] (nl) {Natural Language Description};
\node[method, below of=nl, fill=red!5, draw=red!60] (llm) {LLM (Direct Generation)};
...
% Labels
\node[above=0.3cm of yaml, font=\bfseries] {Model-Driven Method};
\node[above=0.3cm of nl, font=\bfseries] {Pure LLM Method};
