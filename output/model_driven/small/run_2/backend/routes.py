...
def create_enrollment(data: EnrollmentCreate, session: Session = Depends(get_session)):
    ...
    # duplicate_enrollment rule: prevent a student from enrolling in the same course more than once
    ...
    # capacity_check rule: prevent enrollment when the course has reached its maximum capacity
