...
export default function DepartmentFormPage() {
        ...
        if (isEdit) {
            fetch(`http://localhost:8000/departments/${id}`)
                ...
                .then(data => {
                    ...
                    fd.head_user_id = data.head_user_id ?? formData.head_user_id;
                    setFormData(fd);
                })
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        if (e.target.name === 'head_user_id') value = value === '' ? null : Number(value);
        ...
        <div className="p-6 max-w-2xl">
            ...
            <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold text-slate-900">
                    {isEdit ? 'Edit' : 'Create New'} Department
                </h1>
            ...
            <form onSubmit={handleSubmit}>
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
                        <h2 className="text-sm font-semibold text-slate-700">Department Details</h2>
                    </div>
