...
export default function AssignmentFormPage() {
        ...
        if (isEdit) {
            fetch(`http://localhost:8000/assignments/${id}`)
                ...
                .then(data => {
                    ...
                    fd.due_date = data.due_date ?? formData.due_date;
                    fd.max_score = data.max_score ?? formData.max_score;
                    setFormData(fd);
                })
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        if (e.target.name === 'max_score') value = value === '' ? null : Number(value);
        ...
        <div className="p-6 max-w-2xl">
            ...
            <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold text-slate-900">
                    {isEdit ? 'Edit' : 'Create New'} Assignment
                </h1>
